...
Мы подключились к криптовалютной бирже Binance через API-ключи. С их помощью получили все торгуемые криптовалютные пары. Чтобы проанализировать больше криптовалют мы рассматривали криптовалютные пары типа "криптовалюта/USDT", поскольку не все криптовалюты могут торговаться в фиатных валютах. Далее собрали котировки для получившихся криптовалютных пар с 01.01.2020 по 10.05.2023. Для более корректного анализа мы взяли топ-68 криптовалют, так как другие криптовалюты более новые, они существуют менее 2 лет, и данных по их котировкам недостаточно для исследования. Получившиеся данные мы представили в <a href="https://github.com/NikaFortem/project_crypto__fen_2023/blob/main/df_price.csv" target="_blank">таблице</a>, где по столбцам представлены валютные пары типа «криптовалюта/USDT», а по строкам: их ежедневные цены начиная с 01.01.2020 и до 10.05.2023.
