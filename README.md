...
биржи Binance. Они представлены в таблице df_price.csv <a href="https://github.com/NikaFortem/project_crypto__fen_2023/blob/main/df_price.csv" target="_blank">df_price.csv</a> .
...
Мы взяли данные о типе криптовалют с сайта https://coinmarketcap.com . Они представлены в текстовом файле type.txt .
